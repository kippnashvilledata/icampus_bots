"""
Title: Infinite Campus Section Enrollments Scraper
File Name: ic_section_enrollments.py
Purpose: Pull section enrollment data from Infinite Campus in order to roster Illuminate
Dependencies: navigator.py, ic_file_mover_headers.py
Description: This file extracts the data viewer report from Infininte Campus in html format and deposit it into the icampus_downloads directory.
Notes:
...
base_file_name = "section_enrollments"
report_xpath = '//*[@id="row119086"]/td[3]'
